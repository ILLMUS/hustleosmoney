...
async function syncReceiptToMoneyTracker(doc: QuoteDocument, userId: string) {
  ...
  // Only the Labour/Services/Margin/Other cost breakdown flows into the Money Tracker.
  // Everything else on the receipt stays as company revenue.
...
export function DocumentProvider({ children }: { children: ReactNode }) {
  ...
  const addDocument = async (doc: QuoteDocument) => {
    ...
    await syncDealForDocument(doc, user.id);
  };
